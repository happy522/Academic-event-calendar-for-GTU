...
if($type == 'admin' || $type == 'teacher'|| $type == 'other') {
	$utype = 'on';
}
?>
	  ...
	  foreach($records as $rec) {
        ...
        <tr>
		  ...
		  <td><?php if($status == "active") {?>
		   ...
		   <td> <a href="../phpmailer/crendentials.php?uemail=<?php echo $user_email;?>&pwd= <?php echo $user_pwd; ?>&uname=<?php echo strtoupper($user_name); ?>"> <button class="btn btn-primary" id="download" style="float:right;"> Send Mail</button></a></td>
		  <?php }?>
        </tr>
        <?php } ?>
      </table>
