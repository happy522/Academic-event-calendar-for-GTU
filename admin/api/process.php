...
function regConfirm() {
	...
	$data = array();
	if (dbQuery($sql) === TRUE) {
  header("Location: ../phpmailer/approved.php?uemail=$email&uname=$uname&stat=$stat");
} else {
...
function calendarView() {
	...
	$bookings = array();
	$sql	= "SELECT u.name AS u_name, u.id AS user_id, r.rdate,r.ename,r.eres,r.eremark, r.status 
