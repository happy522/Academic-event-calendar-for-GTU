...
function bookCalendar() {
	...
	*/
	...
	$sql = "INSERT INTO tbl_reservations (sec_head_name,uid,ename,eres,evenue,eremark, rdate, status, comments, bdate) 
			VALUES ('$sechname','$userId','$ename','$eres','$even','$erem', '$bkdate', 'PENDING', '', NOW())";
	dbQuery($sql);
	...
	$data = array('to' => 'sardarravu@gmail.com', 'sub' => 'Booking on $rdate.', 'msg' => $bodymsg);
	//send_email($data);
